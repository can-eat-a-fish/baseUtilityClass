...
import cn.we.base.widget.content.AudioChatWaveView;

/**
 * 2017年7月19日12:48:23
 */
public class MediaChatManager {
    private final String TAG = MediaChatManager.class.getName();
    private static MediaChatManager manager1;
    public static MediaChatManager getInstance() {
        if (manager1 == null) {
            synchronized (MediaChatManager.class) {
                if (manager1 == null) {
                    manager1 = new MediaChatManager();
                }
            }
        }
        return manager1;
    ...
    private AudioChatWaveView bindView;//当前播放页

    public MediaChatManager() {
        setMediaPlayer();
    }
     ...
     */
    public void seturl_start_paused(String url, AudioChatWaveView bindView) {
