 ...
 * 类的信息：
 *		1.程序名称： CreateBmpFactory
 *		2.功能描述：BmpFactory工具类
 * 编辑履历：
 *		作者				日期					版本				修改内容
...
public class CreateBmpFactory {
	...
	// ----------相机图片的业务相关
	private static final int PHOTO_REQUEST_CAREMA = 50;// 拍照
	private static final int PHOTO_REQUEST_GALLERY = 60;// 从相册中选择
