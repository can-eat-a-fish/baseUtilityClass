...
import cn.we.base.widget.content.AudioListWaveView1;

/**
 * 2017年7月19日12:48:23
 */
public class MediaManager1 {
    private final String TAG = MediaManager1.class.getName();
    private static MediaManager1 manager1;
    public static MediaManager1 getInstance() {
        if (manager1 == null) {
            synchronized (MediaManager1.class) {
                if (manager1 == null) {
                    manager1 = new MediaManager1();
                }
            }
        }
        return manager1;
    ...
    private AudioListWaveView1 bindView;//当前播放页

    private MediaManager1() {
        setMediaPlayer();
    }
     ...
     */
    public void seturl_start_paused(String url, AudioListWaveView1 bindView) {
